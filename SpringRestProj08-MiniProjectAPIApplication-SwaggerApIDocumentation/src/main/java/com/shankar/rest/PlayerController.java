...
public class PlayerController {
	...
	public ResponseEntity<String> savePlayerInfo(@RequestBody Player player){
		...
		return new ResponseEntity<String>(msg,HttpStatus.CREATED);
			...
			return new ResponseEntity<String>("Problem in Player Enrollment",HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	@GetMapping("/preport")
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200",description = "Sucessful operation -OK")})
	public ResponseEntity<?> findplayerbyId(@PathVariable("pid") int pid){
		try {
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200",description = "Sucessful operation -OK")})
	public ResponseEntity<String> updatePlayerInfo(@RequestBody Player player){
		try {
		...
		@Operation(summary = "Update Operation",description = "Updating Player Information Into Data Base Table")
		@ApiResponses(value = {@ApiResponse(responseCode = "200",description = "Sucessful operation -OK")})
		public ResponseEntity<String> updatePlayerPrice(@PathVariable("id") int id,@PathVariable("percentage") double percentage){
			try {
		...
		@ApiResponses(value = {@ApiResponse(responseCode = "200",description = "Sucessful operation -OK")})
		public ResponseEntity<String> deletePlayerbySalaryRange(@PathVariable("start") double start,@PathVariable("end") double end){
			try {
		...
		@ApiResponses(value = {@ApiResponse(responseCode = "200",description = "Sucessful operation -OK")})
		public ResponseEntity<String> removePlayeryId(@PathVariable("id") int id){
			try {
